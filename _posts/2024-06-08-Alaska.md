...
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true"  centered-slides="true" space-between="40">
  ...
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/blogs/alaska/nature3.jpg" class="img-fluid rounded z-depth-1 limith" %}
  </swiper-slide>
</swiper-container>
